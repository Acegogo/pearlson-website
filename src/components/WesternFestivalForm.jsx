...
const WesternFestivalForm = () => {
  ...
  if (success) {
    return (
      <div className="flex flex-col items-center justify-center py-12 animate-fade-in">
        ...
        <div className="text-lg text-amber-700">Thank you for registering for Western Edition 2026. We will contact you soon.</div>
      </div>
    );
  }
  ...
  return (
    ...
    >
      <input type="hidden" name="form-name" value="festival-western-2026" />
      <input type="hidden" name="festival-edition" value="Western Edition 2026" />
