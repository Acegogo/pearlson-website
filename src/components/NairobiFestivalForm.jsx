...
const NairobiFestivalForm = () => {
  ...
  if (success) {
    return (
      <div className="flex flex-col items-center justify-center py-12 animate-fade-in">
        ...
        <div className="text-lg text-amber-700">Thank you for registering for Nairobi Edition 2026. We will contact you soon.</div>
      </div>
    );
  }
  ...
  return (
    ...
    >
      ...
      <input type="hidden" name="form-name" value="festival-nairobi-2026" />
      <input type="hidden" name="festival-edition" value="Nairobi Edition 2026" />
      <p style={{ display: 'none' }}>
        <label>Don't fill this out if you're human: <input name="bot-field" /></label>
      </p>

      <h2 className="text-2xl font-bold mb-4 text-[#FF4500]">Multilingual Festival Registration - Nairobi Edition 2026</h2>
...
export default NairobiFestivalForm;
