...
const CoastFestivalForm = () => {
  ...
  if (success) {
    return (
      <div className="flex flex-col items-center justify-center py-12 animate-fade-in">
        ...
        <div className="text-lg text-amber-700">Thank you for registering for Coast Edition 2026. We will contact you soon.</div>
      </div>
    );
  }
  ...
  return (
    ...
    >
      <input type="hidden" name="form-name" value="festival-coast-2026" />
      <input type="hidden" name="festival-edition" value="Coast Edition 2026" />
      <p style={{ display: 'none' }}>
        <label>Don't fill this out if you're human: <input name="bot-field" /></label>
      </p>

      <h2 className="text-2xl font-bold mb-4 text-[#FF4500]">Multilingual Festival Registration - Coast Edition 2026</h2>
...
export default CoastFestivalForm;
