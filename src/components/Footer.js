...
const Footer = () => {
  ...
  const footerLinks = {
    ...
    social: [
      ...
      {
        label: 'Instagram',
        url: 'https://www.instagram.com/pearlson_languages/',
        icon: (
          <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
            <path
              fillRule="evenodd"
      ...
      {
        label: 'Facebook',
        url: 'https://web.facebook.com/profile.php?id=61576307943244',
        icon: (
          <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
            <path
              fillRule="evenodd"
  ...
  return (
    <footer className="bg-teal text-cream relative z-20">
      <div className="container-custom py-12">
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-300">
              <li className="flex items-start">
                <svg
                  className="w-6 h-6 mr-2 text-pearlson-red"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
        ...
        <div className="border-t border-gray-700 mt-12 pt-8 text-center text-gray-300">
          <p>&copy; {currentYear} Pearlson Languages and Solutions. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
